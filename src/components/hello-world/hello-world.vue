<template>
  <div class="hello">
    ...
    <p>
      ...
      check out the <a href="https://cli.vuejs.org" target="_blank">vue-cli documentation</a>.
    </p>
    ...
    <ul>
      ...
      <li>
        <a href="https://github.com/vuejs/vue-cli/tree/dev/packages/%40vue/cli-plugin-pwa" target="_blank">pwa</a>
      </li>
      <li>
